...
echo "##############################################################################"
echo "INFO: To SSH Into Cluster Nodes: ssh -p <port> " $couchbase_vm_admin_account_name"@$service_name.cloudapp.net -i "$couchbase_vm_auth_cert_private" -o StrictHostKeyChecking=no" 
